  ...
  return (
    <div className="relative">
      ...
      <button 
        ...
        className="bg-[#1e233d] hover:bg-[#2a3052] cursor-pointer transition-all px-6 py-2.5 rounded-lg flex items-center gap-4 shadow-2xl border border-white/5"
      >
        <img src={iconUnits} alt="Settings" className="w-4 h-4 opacity-70" />
        <span className="text-[15px] font-medium tracking-wide text-white">Units</span>
        <img 
          src={iconDropdown} 
          alt="" 
          className={`w-3 h-3 opacity-40 transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`} 
        />
      </button>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <button 
              onClick={() => handleUnitChange(unit === 'metric' ? 'imperial' : 'metric')}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <p className="text-[10px] text-white/20 uppercase font-black">Temperature</p>
                <UnitRow 
                  label="Celsius (°C)" 
                  active={unit === 'metric'} 
              ...
              <div className="space-y-3">
                <p className="text-[10px] text-white/20 uppercase font-black">Wind Speed</p>
                <UnitRow 
                  label="km/h" 
                  active={unit === 'metric'} 
                  onClick={() => handleUnitChange('metric')} 
              ...
              <div className="space-y-3">
                <p className="text-[10px] text-white/20 uppercase font-black">Precipitation</p>
                <UnitRow 
